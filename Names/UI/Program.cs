...
public static class Program
{
	...
	public static void ShowPlots()
	{
		...
		Charts.ShowHistogram(HistogramTask.GetBirthsPerDayHistogram(namesData, "виталий"),
			"Рождаемость людей с именем Юрий");
		Charts.ShowHistogram(HistogramTask.GetBirthsPerDayHistogram(namesData, "амина"),
